...
local function handle_term_enter()
  local _, term = terms.identify()
  if term then
    --- NOTE: Reset the filetype here because it may be reset by other plugins
    --- (e.g., telescope.nvim). We check first to avoid unnecessary updates.
...
local function setup_commands()
  ...
  command("ToggleTermSendVisualLines", function(args)
    M.send_lines_to_terminal("visual_lines", false, args)
